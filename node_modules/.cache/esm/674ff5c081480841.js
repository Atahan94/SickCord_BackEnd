let User,Token,jwt,env;_814‍.x([["createUser",()=>createUser],["signUpUser",()=>signUpUser],["loginUser",()=>loginUser],["getToken",()=>getToken],["removeToken",()=>removeToken],["updateUser",()=>updateUser],["deleteUserServer",()=>deleteUserServer],["getUser",()=>getUser]]);_814‍.w("../models/User",[["default",["User"],function(v){User=v}]]);_814‍.w("../models/token(temporary)",[["default",["Token"],function(v){Token=v}]]);_814‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_814‍.w("dotenv",[["default",["env"],function(v){env=v}]]);
...
env.config();
  ...
  new Promise((resolve, reject) => {
    ...
    try {
      _814‍.g.console.log("controller", name, email, password)
    ...
    try {
      ...
      _814‍.g.console.log("USERR", user.name)
  ...
  async function updateOrCreateToken(username, newToken) {
    try {
        ...
        _814‍.g.console.error('Token işlemi sırasında hata:', error);
    }
}

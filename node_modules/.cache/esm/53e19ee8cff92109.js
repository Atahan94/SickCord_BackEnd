let updateUser,getUser;_cff‍.x([["default",()=>_cff‍.o]]);_cff‍.w("../../../controller/user",[["updateUser",["updateUser"],function(v){updateUser=v}],["getUser",["getUser"],function(v){getUser=v}]]);
...
const addFriends =  async (req, res) => {
    try {
      ...
      _cff‍.g.console.log("error on the request", error.message)

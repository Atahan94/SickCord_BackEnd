let User,Token,jwt,env;_c3c‍.x([["createUser",()=>createUser],["signUpUser",()=>signUpUser],["loginUser",()=>loginUser],["getToken",()=>getToken],["removeToken",()=>removeToken],["updateUser",()=>updateUser],["deleteUserServer",()=>deleteUserServer],["getUser",()=>getUser],["getUserById",()=>getUserById]]);_c3c‍.w("../models/User",[["default",["User"],function(v){User=v}]]);_c3c‍.w("../models/token(temporary)",[["default",["Token"],function(v){Token=v}]]);_c3c‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_c3c‍.w("dotenv",[["default",["env"],function(v){env=v}]]);
...
const sign = (obj) =>
  ...
  try {
    ...
    _c3c‍.g.console.log("LOGİN USER",user);
    return Promise.resolve({
      user: {
        id: user._id,
        email: user.email,
...
async function updateOrCreateToken(username, newToken) {
  try {
    ...
    _c3c‍.g.console.error("Token işlemi sırasında hata:", error);
  }
}

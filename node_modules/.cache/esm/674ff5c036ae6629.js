let User,Token,jwt,env;_36a‍.x([["createUser",()=>createUser],["signUpUser",()=>signUpUser],["loginUser",()=>loginUser],["getToken",()=>getToken],["removeToken",()=>removeToken],["updateUser",()=>updateUser],["deleteUserServer",()=>deleteUserServer],["getUser",()=>getUser]]);_36a‍.w("../models/User",[["default",["User"],function(v){User=v}]]);_36a‍.w("../models/token(temporary)",[["default",["Token"],function(v){Token=v}]]);_36a‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_36a‍.w("dotenv",[["default",["env"],function(v){env=v}]]);
...
env.config();
  ...
  new Promise((resolve, reject) => {
    ...
    try {
      _36a‍.g.console.log("controller", name, email, password)
    ...
    try {
      ...
      _36a‍.g.console.log("USERR", user.name)
  ...
  async function updateOrCreateToken(username, newToken) {
    try {
        ...
        _36a‍.g.console.error('Token işlemi sırasında hata:', error);
    }
}

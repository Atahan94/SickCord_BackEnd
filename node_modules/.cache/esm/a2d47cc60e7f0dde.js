let mongoose,updateUser,getUser;_0e7‍.x([["default",()=>_0e7‍.o]]);_0e7‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_0e7‍.w("../../../controller/user",[["updateUser",["updateUser"],function(v){updateUser=v}],["getUser",["getUser"],function(v){getUser=v}]]);
...
const createChat =  async (req, res) => {
   ...
   // İMPLEMENT CHAT APİS AND İT'S FRONTEND THEN İMPLEMENT MESSEAGES AND VOİCE CHAT WİTH WEB SOCKET
      ...
      _0e7‍.g.console.log("error on the request", error)

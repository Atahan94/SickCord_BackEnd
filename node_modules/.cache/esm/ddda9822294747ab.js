let updateServer;_294‍.x([["default",()=>_294‍.o]]);_294‍.w("../../../../controller/server",[["updateServer",["updateServer"],function(v){updateServer=v}]]);
...
const editChannel =  async (req, res) => {
    try {
      ...
      _294‍.g.console.log("error on the request", error)

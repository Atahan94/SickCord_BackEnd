let updateUser,getUser;_a93‍.x([["default",()=>_a93‍.o]]);_a93‍.w("../../../controller/user",[["updateUser",["updateUser"],function(v){updateUser=v}],["getUser",["getUser"],function(v){getUser=v}]]);
...
const addFriends =  async (req, res) => {
    try {
      ...
      _a93‍.g.console.log("error on the request", error.message)

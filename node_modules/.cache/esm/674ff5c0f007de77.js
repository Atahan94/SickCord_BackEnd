let User,Token,jwt,env;_f00‍.x([["createUser",()=>createUser],["signUpUser",()=>signUpUser],["loginUser",()=>loginUser],["getToken",()=>getToken],["removeToken",()=>removeToken],["updateUser",()=>updateUser],["deleteUserServer",()=>deleteUserServer],["getUser",()=>getUser],["getUserById",()=>getUserById]]);_f00‍.w("../models/User",[["default",["User"],function(v){User=v}]]);_f00‍.w("../models/token(temporary)",[["default",["Token"],function(v){Token=v}]]);_f00‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_f00‍.w("dotenv",[["default",["env"],function(v){env=v}]]);
...
const sign = (obj) =>
  ...
  try {
    ...
    _f00‍.g.console.log("Userrrr", user)
...
async function updateOrCreateToken(username, newToken) {
  try {
    ...
    _f00‍.g.console.error("Token işlemi sırasında hata:", error);
  }
}
